module multiplier_4(output [7:0] o,input [3:0]a,b);
    ...
    full_adder_8 adder_1(.sum(inter1),.carry(c1),.a(m0),.b(m1),.cin(1'b0));//8 bit adders
    full_adder_8 adder_2(.sum(inter2),.carry(c2),.a(inter1),.b(m2),.cin(1'b0));
    full_adder_8 adder_3(.sum(o),.carry(c3),.a(inter2),.b(m3),.cin(1'b0));
endmodule