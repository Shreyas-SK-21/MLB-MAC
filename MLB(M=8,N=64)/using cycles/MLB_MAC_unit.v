module MLB_unit(output signed [32:0] out,output done,input [7:0] alpha_x,alpha_w,input [63:0] axi,awi,input[12:0]K,input clk,rst,valid_in);//xnor_popcount of axi and awi and alpha_x and alpha_w is the matrix constants
