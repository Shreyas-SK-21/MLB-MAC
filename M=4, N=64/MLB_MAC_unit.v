module MLB_unit(output signed [16:0] out,input [3:0] alpha_x,alpha_w,input [63:0] axi,awi);//xnor_popcount of axi and awi and alpha_x and alpha_w is the matrix constants
