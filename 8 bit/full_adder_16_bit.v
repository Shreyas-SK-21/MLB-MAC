module full_adder_16(output [15:0] sum, output carry, input [15:0] a,b, input cin);
    wire inter1,inter2,inter3,inter4,inter5,inter6,inter7,inter8,inter9,inter10,inter11,inter12,inter13,inter14,inter15;//intermediates
    ...
    full_adder adder_16(.sum(sum[15]),.carry(carry),.a(a[15]),.b(b[15]),.cin(inter15));
endmodule