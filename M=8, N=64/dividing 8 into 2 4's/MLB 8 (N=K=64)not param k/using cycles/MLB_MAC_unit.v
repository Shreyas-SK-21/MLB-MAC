module MLB_unit(output signed [23:0] out,output done,input [7:0] alpha_x,alpha_w,input [63:0] axi,awi,input clk,rst,valid_in);//xnor_popcount of axi and awi and alpha_x and alpha_w is the matrix constants
