// ============================================================
// Full Integer MAC -- M=4, N=K=256  (Sign-After-Multiply version)
//
...
//
// Block 1 : 256 parallel unsigned MAC lanes
...
//
// Block 2 : Reduction tree 256 -> 1         (18-bit signed result)
//
...
//   a_flat   -- 256 x 4-bit UNSIGNED activations (1024-bit bus)
//   b_flat   -- 256 x 4-bit UNSIGNED weights     (1024-bit bus)
//   sign_flat-- 256 x 1-bit product sign         (sign_x XOR sign_w)
...
module int_mac_256 (
    ...
    // (BLOCK 0) to avoid a single flat net driving all 256 accumulator
    // lanes -- see gen_int_mac_n() patch, added to fix max_fanout/max_cap
    // violations on 'rst' (fanout ~256*22, e.g. 5633 @ N=256) and 'load'.
...
// 'rst' or 'load' net driving all 256 accumulator lanes blows past
...
// ============================================================
// BLOCK 1 -- 256 parallel unsigned Multiply + sign + Accumulate
//
...
// s_final : signed 18-bit
// scaled  : 27-bit (truncated to 21)
// ============================================================
