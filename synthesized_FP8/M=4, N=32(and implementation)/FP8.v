module fp8_mlb_top(output signed [19:0] wide_integer_sum,output signed [8:0] shared_exponent,output mac_done,input clk,rst,valid_in,input [255:0] fp8_activations,fp8_weights);
    ...
    wire [31:0] pos_mask = ~sign_k_d1;
    wire [31:0] neg_mask = sign_k_d1;
