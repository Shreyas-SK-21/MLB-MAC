...
module tb_fp8_mlb_top;
    ...
    wire signed [22:0] wide_integer_sum;
...
task fill_random_lanes(input allow_zero);
    ...
    // ------------------------------------------------------------------
    // Pack the 256 lanes into the 2048-bit DUT inputs
    // ------------------------------------------------------------------
    task pack_vectors;
        integer i;
        begin
    ...
    // ------------------------------------------------------------------
task compute_reference(output reg signed [22:0] ref_result,
...
task apply_and_check(input [8*40-1:0] name);
        reg signed [22:0] expected_result;
    ...
    initial begin
        ...
        // 9: single nonzero lane among 255 zero lanes
        clear_all_lanes;
