...
module tb_fp8_mlb_top;
    ...
    // ------------------------------------------------------------------
    reg [7:0] act_lane [0:127];
    reg [7:0] wt_lane  [0:127];
...
task fill_random_lanes(input allow_zero);
    ...
    // ------------------------------------------------------------------
    // Pack the 128 lanes into the 1024-bit DUT inputs
    // ------------------------------------------------------------------
    task pack_vectors;
        integer i;
        begin
...
task apply_and_check(input [8*40-1:0] name);
    ...
    initial begin
        ...
        // 9: single nonzero lane among 127 zero lanes
        clear_all_lanes;
