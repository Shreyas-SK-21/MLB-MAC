module bfp_aligner (
    ...
    always @(*) begin
        ...
        for (i=0; i<25; i=i+1) begin
            ...
            aligned_planes[i]         = shifted_mant[0]; // Plane 0 (axi[24:0])
            aligned_planes[25 + i]  = shifted_mant[1]; // Plane 1 (axi[49:25])
            aligned_planes[50 + i] = shifted_mant[2]; // Plane 2 (axi[74:50])
            aligned_planes[75 + i] = shifted_mant[3]; // Plane 3 (axi[99:75])
        end
    end
endmodule
