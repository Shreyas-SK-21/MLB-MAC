module fp8_mlb_top(output signed [16:0] wide_integer_sum,output signed [8:0] shared_exponent,output mac_done,input clk,rst,valid_in,input [199:0] fp8_activations,fp8_weights);
    ...
    wire signed [15:0] shared_sum_out;
    wire shared_done;
