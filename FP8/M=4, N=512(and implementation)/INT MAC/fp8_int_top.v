module fp8_int_top (
    ...
    wire [2047:0] a_flat_wire;
    wire [2047:0] b_flat_wire;
    ...
    always @(*) begin
        for (i = 0; i < 512; i = i + 1) begin
            ...
            mant_x = {axi_planes[1536+i], axi_planes[1024+i], axi_planes[512+i], axi_planes[i]};
            mant_w = {awi_planes[1536+i], awi_planes[1024+i], awi_planes[512+i], awi_planes[i]};
    ...
    genvar k;
    generate
        for (k = 0; k < 512; k = k + 1) begin : pack_flat
