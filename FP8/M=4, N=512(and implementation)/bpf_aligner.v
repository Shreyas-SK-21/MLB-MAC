module bfp_aligner (
    ...
    always @(*) begin
        ...
        for (i=0; i<512; i=i+1) begin
            ...
            aligned_planes[i]         = shifted_mant[0]; // Plane 0 (axi[511:0])
            aligned_planes[512 + i]  = shifted_mant[1]; // Plane 1 (axi[1023:512])
            aligned_planes[1024 + i] = shifted_mant[2]; // Plane 2 (axi[1535:1024])
            aligned_planes[1536 + i] = shifted_mant[3]; // Plane 3 (axi[2047:1536])
        end
    end
endmodule
