module bfp_aligner (
    ...
    always @(*) begin
        ...
        for (i=0; i<32; i=i+1) begin
            ...
            aligned_planes[i]         = shifted_mant[0]; // Plane 0 (axi[31:0])
            aligned_planes[32 + i]  = shifted_mant[1]; // Plane 1 (axi[63:32])
            aligned_planes[64 + i] = shifted_mant[2]; // Plane 2 (axi[95:64])
            aligned_planes[96 + i] = shifted_mant[3]; // Plane 3 (axi[127:96])
        end
    end
endmodule
