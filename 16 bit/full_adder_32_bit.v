module full_adder_32(output [31:0] sum,output carry, input [31:0] a,b, input cin);
    wire inter1,inter2,inter3,inter4,inter5,inter6,inter7,inter8,inter9,inter10,inter11,inter12,inter13,inter14,inter15,inter16,inter17,inter18,inter19,inter20,inter21,inter22,inter23,inter24,inter25,inter26,inter27,inter28,inter29,inter30,inter31;//intermediates
    ...
    full_adder adder_32(.sum(sum[31]),.carry(carry),.a(a[31]),.b(b[31]),.cin(inter31));
endmodule